...
class SequenceDataset(Dataset):
    ...
    def release_records(self) -> None:
        ...
        ``seq_ids``, ``seq_lens``, ``num_seq`` and ``max_len`` stay valid;
        anything that touches a record (:meth:`get_record`,
        :meth:`get_standardized_seq`, :meth:`get_encoded_seq`,
        :meth:`get_header`) raises afterwards.
        """
        self.close()
        self.record_dict = {}
        self.indexed = False

...
def make_rate_matrix(exchangeabilities, equilibrium, epsilon=1e-16):
    ...
    Args:
        ...
        equilibrium: A vector of relative amino acid frequencies. Shape: (25)
    Returns:
        Normalized rate matrices. Output shape: (k, 25, 25)
    """
    Q = exchangeabilities * tf.reshape(equilibrium, (1, 1, -1))
    ...
    mue = tf.reshape(equilibrium, (1, -1, 1)) * diag
